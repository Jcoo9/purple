...
(function(){
  ...
  // Inject styles
  var css=[
    '#'+UID+',#'+UID+' *{box-sizing:border-box!important;margin:0;padding:0}',
    ...
    // Both sides
    '#'+UID+' .pp-sides{display:flex!important;flex-direction:row!important;background:'+C.ink+';cursor:pointer;border-top:1px solid '+C.rule+'}',
    '#'+UID+' .pp-side{flex:1!important;padding:10px 12px;min-width:0}',
    ...
    // Vote buttons
    '#'+UID+' .pp-btns{display:flex!important;flex-direction:row!important;border-top:1px solid '+C.rule+';border-bottom:1px solid '+C.rule+'}',
    '#'+UID+' .pp-btn{flex:1!important;padding:14px 8px;cursor:pointer;background:transparent;border:none;display:flex!important;flex-direction:column!important;align-items:center!important;gap:3px;transition:background 0.15s}',
    ...
    '#'+UID+' .pp-nuance{display:flex!important;flex-direction:row!important;border-bottom:1px solid '+C.rule+'}',
    '#'+UID+' .pp-nub{flex:1!important;padding:7px;cursor:pointer;background:transparent;border:none;font-family:monospace;font-size:7px;letter-spacing:0.06em;text-transform:uppercase;color:'+C.ink3+';transition:background 0.15s;text-align:center}',
